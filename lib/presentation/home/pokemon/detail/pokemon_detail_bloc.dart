...
final pokemonDetailBlocProvider =
  ...
  final bloc = PokemonDetailBloc(getPokemonDetailUC: getPokemonDetailUC, pokemonId: pokemonId);
...
class PokemonDetailBloc with SubscriptionHolder {
  ...
  Stream<PokemonDetailState> _fetchPokemonDetail() async* {
    ...
    try {
      final pokemonDetail =
          await _getPokemonDetailUC.getFuture(GetPokemonDetailUCParams(_pokemonId));
